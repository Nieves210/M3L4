...
#with this command the bot is gonna send a message to the user
...
#with this command the bot is gonna give the user info about what they can do that's available in this bot
...
#this command asks the user the name of their project and its link and then its status (if it's done or not) and lastly texts you that your new project is saved
...
#this command gives you information about your projects and if you don't have any it gives you a notification that you don' have any
